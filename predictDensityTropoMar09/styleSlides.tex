...
\usepackage{color, rotating, times, amssymb, amsmath, pause, graphicx, subfigure, tabularx, lscape, multirow, natbib}
...
{\begin{list}{\textcolor{darkgreen}{$\bullet$}}
             {\setlength{\leftmargin}{0.5in}\setlength{\itemsep}{-1ex}}}
{\end{list}}
